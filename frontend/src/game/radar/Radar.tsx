...
export function Radar({ radar, size }: Props): JSX.Element {
  ...
  return (
    <svg viewBox={`0 0 ${SIZE} ${SIZE}`} className="w-full" style={size !== undefined ? { width: size, height: size } : { maxWidth: 300 }} role="img"
